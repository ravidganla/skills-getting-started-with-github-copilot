...
activities = {
    ...
    "Basketball Team": {
        "description": "Team training, drills, and friendly basketball games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["jason@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice, technique improvement, and swim meets",
    ...
    "Debate Team": {
        "description": "Practice public speaking, prepare arguments, and compete in debates",
